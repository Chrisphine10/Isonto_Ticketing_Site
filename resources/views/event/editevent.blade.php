                ...
                <div class="card-body">
                    ...
                    @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" required class="form-control" id="name" name='name' value={{ $event->name }}>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="description" class="col-md-4 col-form-label text-md-right">Description</label>
                            <div class="col-md-6">
                                <textarea type="text" style="height: 200px;" required class="form-control" id="description" name='description'>{{ $event->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="city" class="col-md-4 col-form-label text-md-right">City</label>
                            <div class="col-md-6">
                                <input type="text" required class="form-control" id="city" name='city' value={{ $event->city }}>
                            </div>
                        </div>
                        <div class="form-group row">
